...
public class FTRLProximal {
    ...
    private FTRLParameters parameters; // parameters->alpha, beta, l1, l2, dimensions

    public double[] n;// n->squared sum of past gradients

    public double[] z;// z->weights

    public Map<Integer, Double> w;// w->lazy weights
